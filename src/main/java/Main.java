...
public class Main {
    ...
    public static void main(String[] args) {
        try (Connection conexion = DriverManager.getConnection("jdbc:mysql://localhost:3306/buen_sabor?useSSL=false&serverTimezone=UTC", "root", "")) {
            ...
            Empresa elBuenSabor = Empresa.builder().id(14L).nombre("El Buen Sabor S.A.").razonSocial("Comidas Rápidas y Gourmet").cuil(2030123456).build();
            ...
            Categoria categoriaPostre = Categoria.builder().id(23L).denominacion("Postres").categoria(categoriaComida).build();

            categoriaComida.getSubcategorias().add(categoriaPostre);
            ...
            Imagen imagenPromo = Imagen.builder().id(43L).denominacion("imagen_promo.jpg").build();
            happyHourHamburguesas.getImagenes().add(imagenPromo);
            ...
            Pedido pedido1 = Pedido.builder().id(46L)
                    ...
                    .factura(factura1).domicilio(domCliente1).sucursal(sucursalMaipu).build();
            ...
            cliente1.getPedidos().add(pedido1); // Añado pedido al cliente
            ...
            Pedido pedido2 = Pedido.builder().id(46L)
                    ...
                    .factura(factura2).domicilio(domCliente2).sucursal(sucursalMaipu).build();
            ...
            Pedido pedido3 = Pedido.builder().id(46L)
                    ...
                    .formaPago(FormaPago.EFECTIVO).fechaPedido(LocalDate.now())
                    .factura(factura3).domicilio(domCliente2).sucursal(sucursalMaipu).build();
